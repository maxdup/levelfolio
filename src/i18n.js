...
const en = {
  ...
  'install-4-alt': ', you can load the map from the main menu with "Find A Game", and then "Create server". Find the map you\'re looking for in the dropdown menu and proceed forward.',
  ...
  '360-title': 'View the 360 panorama of the level',
  '3d-title': 'View the 3D level visualization',
  'loading': 'Loading...',
  'modal-close': 'Close',
  'carousel-fullscreen': 'View fullscreen',
  'carousel-next': 'Next',
  ...
  'map-added': 'Added to Team Fortress 2 as part of the ',
  'map-added-toughbreak': '"Tough Break" update',
  'map-added-smissmas2020': '"Smissmas 2020" update',
  'map-added-hover': 'See the update page',
  'article-pcgamer': '"Great TF2 community map"',
  'article-hover': 'See the article',
...
const fr = {
  ...
  'install-4-alt': ', vous pouvez charger le niveau à partir du menu principal avec "Find A Game", puis "Create server". Trouvez le niveau dans le menu déroulant et chargez la partie.',
  ...
  '360-title': 'Voir le panorama du niveau',
  '3d-title': 'Voir le niveau en 3D',
  'loading': 'Chargement...',
  'modal-close': 'Fermer',
  'carousel-fullscreen': ' Plein écran',
  ...
  'snowville': "Une recontextualization festive du niveau Sawmill par Valve. Pour ce projet, Le but était de voir si il était viable de travailler avec une plus grande équipe de moddeurs. C'était le bon projet pour experimenter puisque c'était principalement qu'un \"art pass\" avec peu de decisions en termes de design. Il n'y avait pas de risques de rester accroché sur des problèmes complexes de gameplay. L'expérience fut un success avec plusieurs personnes arrivant tous à faire des contributions significatives malgrés les niveaux de compétance variés au sein de l'équipe.",
  ...
  'map-added': 'Ajouté à Team Fortress 2 avec la mise à jour ',
  'map-added-toughbreak': '"Tough Break"',
  'map-added-smissmas2020': '"Smissmas 2020"',
  'map-added-hover': 'voir la page web',
  'article-pcgamer': '"Great TF2 community map"',
  'article-hover': "Voir l'article",
