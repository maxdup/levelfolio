  ...
  .config([
    '$translateProvider', function($translateProvider) {
      $translateProvider.translations('en', {
        ...
        'install-4-alt': ', you can load the map from the main menu with "Start playing", and then "Create server". Find the map you\'re looking for in the dropdown menu and proceed forward.',
      ...
      $translateProvider.translations('fr', {
        ...
        'install-4-alt': ', vous pouvez charger le niveau à partir du menu principal avec "Start playing", puis "Create server". Trouvez le niveau dans le menu déroulant et chargez la partie.',
